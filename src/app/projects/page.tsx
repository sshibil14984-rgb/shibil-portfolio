...
export default async function ProjectsPage() {
  ...
  return (
    <div className="py-24 px-4 sm:px-6 max-w-6xl mx-auto min-h-screen">
      <div className="mb-16">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-white">Project Showcase</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {data.length === 0 ? (
          ...
          data.map((p) => (
            <article key={p.id} className="group relative flex flex-col p-6 rounded-3xl border border-white/5 bg-zinc-900/50 hover:bg-zinc-900 transition-colors shadow-xl">
              <div className="mb-4">
